...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xpm -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_hdmi xil_defaultlib.tb_hdmi xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  tb_hdmi -key {Behavioral:sim_1:Functional:tb_hdmi} -tclbatch cmd.tcl -log simulate.log
}
