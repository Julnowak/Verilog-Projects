...
#
# Generated by export_simulation on Thu Apr 27 02:05:56 +0200 2023
#
################################################################################
...
'-reset_run' switch to the './thresh_0.sh' script.

./thresh_0.sh -reset_run
...
./thresh_0.sh -noclean_files

For more information on the script, please type './thresh_0.sh -help'.
